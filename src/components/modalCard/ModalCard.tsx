...
const ModalCard = ({ isOpen, setOpenModal, how, tecs, langs, title }: ModalProps) => {
  ...
  if (isOpen) return (
    <div className="z-50 flex fixed top-0 right-[-100px] p-[25px]  w-[40%] h-[100vh]  flex-col backdrop-blur-sm bg-greyGlass4  rounded-lg  shadow-[-15px_15px_15px_rgba(0,0,0,0.2)]">
      <button onClick={() => setOpenModal(false)} className="flex items-center justify-center w-[45px] h-[45px] absolute top-[55px] left-[-23px] bg-[#323232] border-[1px] border-solid rounded-full border-greyGlass2 hover:bg-[#ff0000] hover:scale-110 transition-all">
