...
export class Player {
    ...
    resetProperties(properties = {}) {
        ...
        if (!isNil(properties.stroke)) {
            updateProperties(this._lottie, this.rawProperties.filter(c => c.name === 'stroke'), properties.stroke, { scale: PROPERTY_SCALE });
        }
        ...
        if (!isNil(properties.scale)) {
            updateProperties(this._lottie, this.rawProperties.filter(c => c.name === 'scale'), properties.scale, { scale: PROPERTY_SCALE });
        }
        else if (alreadyCustomized) {
        ...
        if (!isNil(properties.axis)) {
            updateProperties(this._lottie, this.rawProperties.filter(c => c.name === 'axis'), properties.axis, { scale: PROPERTY_SCALE });
        }
        else if (alreadyCustomized) {
    ...
    set scale(scale) {
        if (isNil(scale)) {
            ...
            updateProperties(this._lottie, this.rawProperties.filter(c => c.name === 'scale'), scale, { scale: PROPERTY_SCALE });
        }
        this.refresh();
    }
    get scale() {
    ...
    set axis(axis) {
        if (isNil(axis)) {
            ...
            updateProperties(this._lottie, this.rawProperties.filter(c => c.name === 'axis'), axis, { scale: PROPERTY_SCALE });
        }
        this.refresh();
    }
    get axis() {
